...
@RestController
@RequestMapping("/api/climax-app-kafka")
public class ClimaxAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ClimaxAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ClimaxAppKafkaResource(KafkaProperties kafkaProperties) {
